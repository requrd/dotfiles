...
export KUBECONFIG=$KUBECONFIG:$HOME/.kube/config/k3s.yaml
...
xmodmap -e 'keycode 46 = l L Prior Prior'
xmodmap -e 'keycode 60 = period greater Next Next'
xmodmap -e 'keycode 45 = k K Home Home'
xmodmap -e 'keycode 59 = comma less End End'
